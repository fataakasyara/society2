...
const Home = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-green-400 to-green-600 bg-size-200 bg-pos-0 animation" style={{
      ...
      <section id="category" className="py-20 bg-gradient-to-b from-blue-50 to-blue-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="animate-title text-3xl md:text-4xl font-bold text-blue-900 mb-4">
              Popular Categories
            </h2>
            <span className="animate-title text-2xl text-blue-600 mt-4 max-w-2xl mx-auto">
              Explore our popular <span className="font-bold text-blue-700 text-3xl">Web 3.0</span> categories that are trending among our community
            </span>
          </div>
      ...
      <section id="about" className="py-20 bg-gradient-to-br from-purple-50 to-purple-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center mb-12">
            <h2 className="animate-title text-4xl font-bold text-purple-900 relative">
              About Us
              <span className="absolute -bottom-2 left-0 w-20 h-1 bg-purple-600"></span>
            </h2>

            <div className="hidden md:block">
              <div className="animate-element flex items-center space-x-2 text-sm text-purple-800 font-medium">
                <span className="text-purple-600">Nolyx Society</span>
              </div>
            </div>
          </div>
          ...
          <div className="mt-16">
            <h3 className="animate-title text-2xl font-semibold mb-8 text-purple-900 text-center">Our Values</h3>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="animate-card p-8 bg-purple-100 rounded-xl shadow-lg transform transition duration-500 hover:-translate-y-2 hover:shadow-xl">
                ...
                <h4 className="font-semibold text-lg mb-3 text-purple-900">Innovation</h4>
              ...
              <div className="animate-card p-8 bg-purple-100 rounded-xl shadow-lg transform transition duration-500 hover:-translate-y-2 hover:shadow-xl">
                ...
                <h4 className="font-semibold text-lg mb-3 text-purple-900">Excellence</h4>
                <p className="text-purple-700">
              ...
              <div className="animate-card p-8 bg-purple-100 rounded-xl shadow-lg transform transition duration-500 hover:-translate-y-2 hover:shadow-xl">
                ...
                <h4 className="font-semibold text-lg mb-3 text-purple-900">Community</h4>
                <p className="text-purple-700">
      ...
      {/* Join Section - Orange Theme */}
      <section id="join" className="py-20 bg-gradient-to-r from-orange-50 to-orange-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-16">
          <div className="text-center mb-10">
            <h2 className="animate-title text-4xl font-bold text-orange-800 mb-4">Become a Nolixian Civilian</h2>
            <p className="animate-content text-xl text-orange-600 max-w-3xl mx-auto">Learn and make projects together.</p>
          </div>

          <div className="flex flex-col items-center justify-center space-y-6">
            <div className="animate-button relative group">
              <div className="absolute -inset-1 bg-gradient-to-r from-orange-600 to-orange-500 rounded-3xl blur opacity-50 group-hover:opacity-75 transition duration-300"></div>
              <button 
                onClick={() => navigate('/join')}
                className="relative bg-gradient-to-r from-orange-600 to-orange-500 hover:from-orange-500 hover:to-orange-400 text-white font-bold py-4 px-10 rounded-3xl shadow-xl flex items-center justify-center transform transition-all duration-300 hover:scale-105 text-2xl"
              >
            ...
            <div className="animate-element flex items-center space-x-3 mt-6">
              ...
              <p className="text-orange-600">Join with <span className="font-semibold text-orange-700">180+</span> other Nolixians</p>
            </div>
          </div>
        </div>
      </section>

      {/* Governance Section - Teal Theme */}
      <section id="governance" className="py-6 md:py-16 bg-gradient-to-br from-teal-50 to-teal-100 overflow-hidden">
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
          <h2 className="governance-title text-xl md:text-3xl font-bold text-teal-800 mb-4 md:mb-8">
            Governance of Society
            <span className="block h-1 w-16 md:w-20 bg-teal-600 mt-1 md:mt-2"></span>
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mb-8">
            ...
            <div className="governance-card carddesign bg-white rounded-lg md:rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
              <div className="p-4 text-center">
                <div className="mx-auto w-20 h-20 md:w-24 md:h-24 rounded-full overflow-hidden ring-2 ring-teal-500 ring-opacity-50 mb-3">
                ...
                <div className="flex justify-center gap-2">
                  <a href="https://kasyara.pages.dev" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center px-3 py-1 bg-teal-600 hover:bg-teal-700 text-white rounded-md text-xs transition-colors duration-300">
                    Website
                  </a>
                </div>
              </div>
            ...
            <div className="governance-card carddesign bg-white rounded-lg md:rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
              <div className="p-4 text-center">
                ...
                <div className="flex justify-center gap-2">
                  <a href="/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center px-3 py-1 bg-teal-600 hover:bg-teal-700 text-white rounded-md text-xs transition-colors duration-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
            ...
            <div className="governance-card carddesign bg-white rounded-lg md:rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
              <div className="p-4 text-center">
                ...
                <div className="flex justify-center gap-2">
                  <a href="#" className="inline-flex items-center justify-center px-3 py-1 bg-teal-600 hover:bg-teal-700 text-white rounded-md text-xs transition-colors duration-300" target="_blank" rel="noopener noreferrer">
