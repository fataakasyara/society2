    ...
    <div className="bg-gradient-to-r from-green-400 to-green-600 bg-size-200 bg-pos-0 animation" style={{
      ...
      <style>{`
        ...
        .hero-title::after {
          ...
          -webkit-background-clip: text;
          -webkit-text-fill-color: transparent;
          animation: glowSweepText 4s ease-in-out infinite;
          z-index: 1;
        }
      ...
      <main id="main-content">
        <section id="hero" className="hero-section h-96 flex items-center justify-center text-white mt-16">
          <div className="text-center hero-title-3d">
            <h1 id="cinzel" className="hero-title animate-hero text-4xl md:text-6xl font-bold mb-4">
              Nolyx Society
            </h1>
            <br />
            <button 
              onClick={handleJoinClick}
              className="animate-button bg-green-700 hover:bg-green-800 text-white px-8 py-3 rounded-full transition-all duration-300 hover:scale-105 focus:outline-none focus:ring-2 focus:ring-green-300"
              aria-label="Scroll to Join Community section"
            >
              Join Community
            </button>
          </div>
        ...
        <section id="category" className="py-20 bg-gradient-to-b from-gray-50 to-gray-100">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
              <a href="#" className="animate-card relative group overflow-hidden rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 green-filter focus:outline-none focus:ring-2 focus:ring-green-500">
        ...
        <section id="about" className="py-20 bg-white" tabIndex="-1">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section id="join" className="py-20 bg-gradient-to-r from-green-50 to-emerald-50" tabIndex="-1">
            ...
            <div className="flex flex-col items-center justify-center space-y-6">
              <div className="animate-button relative group">
                ...
                <button 
                  ...
                  className="relative bg-gradient-to-r from-green-600 to-emerald-500 hover:from-green-500 hover:to-emerald-400 text-white font-bold py-4 px-10 rounded-3xl shadow-xl flex items-center justify-center transform transition-all duration-300 hover:scale-105 text-2xl focus:outline-none focus:ring-2 focus:ring-green-300"
                  aria-label="Navigate to Join Community page"
                >
        ...
        <section id="governance" className="py-6 md:py-16 bg-gradient-to-br from-green-50 to-green-100 overflow-hidden" tabIndex="-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mb-8">
              ...
              <div className="governance-card carddesign bg-white rounded-lg md:rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                <div className="p-4 text-center">
                  ...
                  <div className="flex justify-center gap-2">
                    <a href="https://kasyara.pages.dev" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center px-3 py-1 bg-green-600 hover:bg-green-700 text-white rounded-md text-xs transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-green-500">
                      Website
                    </a>
                  </div>
                </div>
              ...
              <div className="governance-card carddesign bg-white rounded-lg md:rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                <div className="p-4 text-center">
                  ...
                  <div className="flex justify-center gap-2">
                    <a href="/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center px-3 py-1 bg-green-600 hover:bg-green-700 text-white rounded-md text-xs transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-green-500">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
              ...
              <div className="governance-card carddesign bg-white rounded-lg md:rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
                <div className="p-4 text-center">
                  ...
                  <div className="flex justify-center gap-2">
                    <a href="#" className="inline-flex items-center justify-center px-3 py-1 bg-green-600 hover:bg-green-700 text-white rounded-md text-xs transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-green-500" target="_blank" rel="noopener noreferrer">
              ...
              <div className="hidden md:grid md:grid-cols-5 gap-8 mb-12">
                ...
                <div className="col-span-2">
                  ...
                  <div className="flex space-x-4">
                    <a href="#" className="bg-white bg-opacity-10 hover:bg-opacity-20 p-3 rounded-lg transition-all duration-300 hover:scale-110 focus:outline-none focus:ring-2 focus:ring-green-300">
                ...
                <div>
                  ...
                  <ul className="space-y-3">
                    <li><a href="#about" className="text-green-200 hover:text-white transition-colors duration-300 flex items-center group focus:outline-none focus:ring-2 focus:ring-green-300 rounded">
                      <i className="fas fa-chevron-right text-xs mr-2 group-hover:translate-x-1 transition-transform"></i>
                      About Us
                    </a></li>
                    <li><a href="#governance" className="text-green-200 hover:text-white transition-colors duration-300 flex items-center group focus:outline-none focus:ring-2 focus:ring-green-300 rounded">
                      <i className="fas fa-chevron-right text-xs mr-2 group-hover:translate-x-1 transition-transform"></i>
                      Governance
                    </a></li>
                    <li><button onClick={() => navigate('/join')} className="text-green-200 hover:text-white transition-colors duration-300 flex items-center group focus:outline-none focus:ring-2 focus:ring-green-300 rounded">
                      <i className="fas fa-chevron-right text-xs mr-2 group-hover:translate-x-1 transition-transform"></i>
                      Join Community
                    </button></li>
                    <li><button onClick={() => navigate('/ai')} className="text-green-200 hover:text-white transition-colors duration-300 flex items-center group focus:outline-none focus:ring-2 focus:ring-green-300 rounded">
                      <i className="fas fa-chevron-right text-xs mr-2 group-hover:translate-x-1 transition-transform"></i>
                      Nolyx AI
                    </button></li>
                  </ul>
                ...
                <div>
                  ...
                  <ul className="space-y-3">
                    <li><a href="#" className="text-green-200 hover:text-white transition-colors duration-300 flex items-center group focus:outline-none focus:ring-2 focus:ring-green-300 rounded">
                      <i className="fas fa-chevron-right text-xs mr-2 group-hover:translate-x-1 transition-transform"></i>
                      Blockchain
                    </a></li>
                    <li><a href="#" className="text-green-200 hover:text-white transition-colors duration-300 flex items-center group focus:outline-none focus:ring-2 focus:ring-green-300 rounded">
              ...
              <div className="md:hidden">
                ...
                <div className="text-center mb-8">
                  ...
                  <div className="flex justify-center space-x-4 mb-8">
                    <a href="#" className="bg-white bg-opacity-10 hover:bg-opacity-20 p-3 rounded-lg transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-green-300">
                      <i className="fab fa-discord text-lg"></i>
                    </a>
                    <a href="#" className="bg-white bg-opacity-10 hover:bg-opacity-20 p-3 rounded-lg transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-green-300">
                      <i className="fab fa-telegram text-lg"></i>
                ...
                <div className="grid grid-cols-2 gap-8 mb-8">
                  <div>
                    ...
                    <ul className="space-y-3">
                      <li><a href="#about" className="text-green-200 hover:text-white transition-colors text-sm focus:outline-none focus:ring-2 focus:ring-green-300 rounded">About Us</a></li>
                      <li><a href="#governance" className="text-green-200 hover:text-white transition-colors text-sm focus:outline-none focus:ring-2 focus:ring-green-300 rounded">Governance</a></li>
                      <li><button onClick={() => navigate('/join')} className="text-green-200 hover:text-white transition-colors text-sm text-left focus:outline-none focus:ring-2 focus:ring-green-300 rounded">Join Community</button></li>
                      <li><button onClick={() => navigate('/ai')} className="text-green-200 hover:text-white transition-colors text-sm text-left focus:outline-none focus:ring-2 focus:ring-green-300 rounded">Nolyx AI</button></li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="space-y-3">
                      <li><a href="#" className="text-green-200 hover:text-white transition-colors text-sm focus:outline-none focus:ring-2 focus:ring-green-300 rounded">Blockchain</a></li>
                      <li><a href="#" className="text-green-200 hover:text-white transition-colors text-sm focus:outline-none focus:ring-2 focus:ring-green-300 rounded">Smart Contracts</a></li>
                      <li><a href="#" className="text-green-200 hover:text-white transition-colors text-sm focus:outline-none focus:ring-2 focus:ring-green-300 rounded">Cryptography</a></li>
                      <li><a href="#" className="text-green-200 hover:text-white transition-colors text-sm focus:outline-none focus:ring-2 focus:ring-green-300 rounded">DeFi</a></li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                  ...
                  <div className="flex flex-wrap justify-center md:justify-end space-x-6 text-sm">
                    <a href="#" className="text-green-200 hover:text-white transition-colors focus:outline-none focus:ring-2 focus:ring-green-300 rounded">Privacy Policy</a>
                    <a href="#" className="text-green-200 hover:text-white transition-colors focus:outline-none focus:ring-2 focus:ring-green-300 rounded">Terms of Service</a>
                    <a href="#" className="text-green-200 hover:text-white transition-colors focus:outline-none focus:ring-2 focus:ring-green-300 rounded">Cookie Policy</a>
                  </div>
                </div>
              </div>
            </div>
