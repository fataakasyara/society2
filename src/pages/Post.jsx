        ...
        <section className="relative bg-white">
          ...
          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div className="flex flex-wrap items-center gap-4 mb-8">
              ...
              >
                <svg className={`w-5 h-5 mr-2 ${isBookmarked ? 'fill-current' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <article className="lg:col-span-8 article-content">
                ...
                <div className="mt-12 pt-8 border-t border-gray-200">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {['Web3', 'Blockchain', 'Technology', formatCategoryName(currentPost.category)].map((tag, index) => (
                      <span 
                        key={index}
                ...
                <div className="sticky top-24 space-y-8">
                  ...
                  <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm">
                    ...
                    <nav className="space-y-2">
                      <a href="#" className="block text-sm text-gray-600 hover:text-green-600 transition-colors py-1">Introduction</a>
                      <a href="#" className="block text-sm text-gray-600 hover:text-green-600 transition-colors py-1">Key Concepts</a>
                      <a href="#" className="block text-sm text-gray-600 hover:text-green-600 transition-colors py-1">Implementation</a>
                      <a href="#" className="block text-sm text-gray-600 hover:text-green-600 transition-colors py-1">Best Practices</a>
                      <a href="#" className="block text-sm text-gray-600 hover:text-green-600 transition-colors py-1">Conclusion</a>
                    </nav>
                  </div>
